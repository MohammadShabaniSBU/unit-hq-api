...
class StageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $siteDefs = [
            ['handle' => 'madrid', 'name' => 'Madrid Centro', 'code' => 'MAD-01', 'address' => 'Calle de Fuencarral 45', 'city' => 'Madrid', 'postal_code' => '28004', 'state_region' => 'Madrid', 'location' => ['lat' => 40.4253, 'lng' => -3.7035], 'latitude' => 40.4253, 'longitude' => -3.7035, 'contact_phone' => '+34910001001', 'country_id' => $spain->id, 'timezone' => 'Europe/Madrid', 'currency' => 'EUR', 'legal_entity_id' => $legalEntity->id, 'delinquency_policy_id' => $esPolicy->id],
            ['handle' => 'norte', 'name' => 'Madrid Norte', 'code' => 'MAD-02', 'address' => 'Avenida de Burgos 89', 'city' => 'Madrid', 'postal_code' => '28036', 'state_region' => 'Madrid', 'location' => ['lat' => 40.4851, 'lng' => -3.6732], 'latitude' => 40.4851, 'longitude' => -3.6732, 'contact_phone' => '+34910001002', 'country_id' => $spain->id, 'timezone' => 'Europe/Madrid', 'currency' => 'EUR', 'legal_entity_id' => $legalEntity->id, 'delinquency_policy_id' => $esPolicy->id],
            ['handle' => 'sur', 'name' => 'Madrid Sur', 'code' => 'MAD-03', 'address' => 'Avenida de Córdoba 21', 'city' => 'Madrid', 'postal_code' => '28026', 'state_region' => 'Madrid', 'location' => ['lat' => 40.3889, 'lng' => -3.6938], 'latitude' => 40.3889, 'longitude' => -3.6938, 'contact_phone' => '+34910001003', 'country_id' => $spain->id, 'timezone' => 'Europe/Madrid', 'currency' => 'EUR', 'legal_entity_id' => $legalEntity->id, 'delinquency_policy_id' => $esPolicy->id],
            ['handle' => 'este', 'name' => 'Madrid Este', 'code' => 'MAD-04', 'address' => 'Calle de Alcalá 412', 'city' => 'Madrid', 'postal_code' => '28027', 'state_region' => 'Madrid', 'location' => ['lat' => 40.4362, 'lng' => -3.6321], 'latitude' => 40.4362, 'longitude' => -3.6321, 'contact_phone' => '+34910001004', 'country_id' => $spain->id, 'timezone' => 'Europe/Madrid', 'currency' => 'EUR', 'legal_entity_id' => $legalEntity->id, 'delinquency_policy_id' => $esPolicy->id],
