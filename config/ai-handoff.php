...
return [
    ...
    */
    ...
    'voice_prompt_additions' => [
        ...
        'Always ask the other agent to do any action: send a quote, text, SMS, email, or link; book, schedule, or confirm a visit; take a name, phone, or email; hold or reserve a unit; resolve a move-in date. Never invent a time or a full phone number.',
