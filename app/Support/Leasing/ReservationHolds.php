...
final class ReservationHolds
{
     ...
     */
    public static function write(Reservation $reservation, Unit $unit, ?int $createdBy = null): UnitHold
    {
    ...
    public static function release(Reservation $reservation): void
    {
        UnitHold::query()
